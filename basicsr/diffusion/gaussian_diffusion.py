...
class GaussianDiffusion:
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None, gt_ker=None, opt = None):
        """
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            if isinstance(model_output, tuple):
                model_output, est_ker = model_output
            else:
                extra = None
           ...
           # model_output, y0_output, r_values = th.split(model_output, C, dim=1)
            ...
            if 'cri_k' in opt:
                ...
                terms["loss"] = terms["loss"] + opt['cri_k']['loss_weight'] * terms["ker"]
        else:
